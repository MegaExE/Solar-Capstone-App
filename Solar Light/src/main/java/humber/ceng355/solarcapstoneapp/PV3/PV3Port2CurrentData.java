        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot dss : dataSnapshot.getChildren()) {
                    ...
                    //Declaring textviews
                    TextView PV3DateTV = getActivity().findViewById(R.id.PV3_Date_Value2);
                    TextView PV3BatteryVoltTV = getActivity().findViewById(R.id.PV3Port2_BatteryVolt_Value);
                    TextView PV3PowerTV = getActivity().findViewById(R.id.PV3Port2_Power_Value);
                    TextView PV3VACinTV = getActivity().findViewById(R.id.PV3Port2_VACin_Value);
